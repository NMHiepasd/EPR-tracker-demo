...
export const SHEETS = [
  {
    ...
    sections:[
      ...
      { id:'vh', lvi:'Thông tin xe & nhà cung cấp', len:'Vehicle & Supplier Information', fields:[
        ...
        { id:'material_type', lv:'Loại nguyên liệu', le:'Material Type', type:'select', req:true, opts:MAT },
      ]},
  ...
  },
  {
    ...
    sections:[
      ...
      { id:'ln', lvi:'Chi tiết cân', len:'Weighing Details', rep:true, rfields:[
        { id:'material_type', lv:'Loại NL', le:'Material Type', type:'select', req:true, opts:MAT },
  ...
  },
  {
    ...
    sections:[
      ...
      { id:'vc', lvi:'Thông tin xe & khách hàng', len:'Vehicle & Customer Information', fields:[
        ...
        { id:'material_type', lv:'Loại hàng', le:'Material Type', type:'select', req:true, opts:MAT },
      ]},
      { id:'wg', lvi:'Kết quả cân', len:'Weighing Results', fields:[
  ...
  },
  {
    ...
    sections:[
      { id:'li', lvi:'Thông tin LOT', len:'LOT Information', fields:[
        ...
        { id:'material_code', lv:'Mã loại hàng', le:'Material Code', type:'select', req:true, opts:['PET','HDPE','PP','PE film','BOPP'] },
  ...
  },
  {
    ...
    sections:[
      { id:'ln', lvi:'Chi tiết phân loại theo LOT', len:'Sorting Details by LOT', rep:true, rfields:[
        ...
        { id:'material_code', lv:'Mã NVL', le:'Material Code', type:'select', req:true, opts:['PET','HDPE','PP','PE film','BOPP'] },
  ...
  {
    id:'S13', group:'REC', lvi:'Thư xác nhận sản lượng (MAC → EGL)', len:'Volume Confirmation Letter (MAC → EGL)', doc_prefix:'VCL',
    sections:[
  ...
  {
    id:'S14', group:'AI', lvi:'Báo cáo tổng hợp (Mass Balance)', len:'Summary Report — Mass Balance', doc_prefix:'SR',
    sections:[
